...
public class SWeeklyrewardsrw implements mytools.ConvMain.Checkable ,Comparable<SWeeklyrewardsrw>{

	public int compareTo(SWeeklyrewardsrw o){
		return this.id-o.id;
	}
	...
	public SWeeklyrewardsrw(){
		super();
	}
	public SWeeklyrewardsrw(SWeeklyrewardsrw arg){
		this.id=arg.id ;
