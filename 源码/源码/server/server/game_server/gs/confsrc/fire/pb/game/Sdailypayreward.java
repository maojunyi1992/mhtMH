...
public class Sdailypayreward implements mytools.ConvMain.Checkable ,Comparable<Sdailypayreward>{

	public int compareTo(Sdailypayreward o){
		return this.id-o.id;
	}
	...
	public Sdailypayreward(){
		super();
	}
	public Sdailypayreward(Sdailypayreward arg){
		this.id=arg.id ;
