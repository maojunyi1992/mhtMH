...
public class Srankwardzh implements mytools.ConvMain.Checkable ,Comparable<Srankwardzh>{

	public int compareTo(Srankwardzh o){
		return this.id-o.id;
	}
	...
	public Srankwardzh(Srankwardzh arg){
		this.id=arg.id ;
