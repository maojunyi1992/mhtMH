...
public class Srankawardreward implements mytools.ConvMain.Checkable ,Comparable<Srankawardreward>{

	public int compareTo(Srankawardreward o){
		return this.id-o.id;
	}
	...
	public Srankawardreward(Srankawardreward arg){
		this.id=arg.id ;
