...
public class Srankwardcw implements mytools.ConvMain.Checkable ,Comparable<Srankwardcw>{

	public int compareTo(Srankwardcw o){
		return this.id-o.id;
	}
	...
	public Srankwardcw(Srankwardcw arg){
		this.id=arg.id ;
