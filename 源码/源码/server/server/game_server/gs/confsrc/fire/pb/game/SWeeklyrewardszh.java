...
public class SWeeklyrewardszh implements mytools.ConvMain.Checkable ,Comparable<SWeeklyrewardszh>{

	public int compareTo(SWeeklyrewardszh o){
		return this.id-o.id;
	}
	...
	public SWeeklyrewardszh(){
		super();
	}
	public SWeeklyrewardszh(SWeeklyrewardszh arg){
		this.id=arg.id ;
