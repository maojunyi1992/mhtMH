...
public class Srankawardrewarcw implements mytools.ConvMain.Checkable ,Comparable<Srankawardrewarcw>{

	public int compareTo(Srankawardrewarcw o){
		return this.id-o.id;
	}
	...
	public Srankawardrewarcw(Srankawardrewarcw arg){
		this.id=arg.id ;
