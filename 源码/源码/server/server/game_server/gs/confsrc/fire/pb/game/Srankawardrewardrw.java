...
public class Srankawardrewardrw implements mytools.ConvMain.Checkable ,Comparable<Srankawardrewardrw>{

	public int compareTo(Srankawardrewardrw o){
		return this.id-o.id;
	}
	...
	public Srankawardrewardrw(Srankawardrewardrw arg){
		this.id=arg.id ;
