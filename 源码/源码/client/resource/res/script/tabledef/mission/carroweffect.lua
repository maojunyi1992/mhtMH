...
CArrowEffectTable = {}
CArrowEffectTable.__index = CArrowEffectTable

function CArrowEffectTable:new()
	local self = {}
	setmetatable(self, CArrowEffectTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CArrowEffectTable:getRecorder(id)
	return self.m_cache[id]
end

function CArrowEffectTable:getAllID()
	return self.allID
end

function CArrowEffectTable:getSize()
	return self.memberCount
end

function CArrowEffectTable:LoadBeanFromBinFile(filename)
