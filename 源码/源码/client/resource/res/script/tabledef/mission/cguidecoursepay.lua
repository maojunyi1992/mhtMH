...
CGuideCoursePayTable = {}
CGuideCoursePayTable.__index = CGuideCoursePayTable

function CGuideCoursePayTable:new()
	local self = {}
	setmetatable(self, CGuideCoursePayTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CGuideCoursePayTable:getRecorder(id)
	return self.m_cache[id]
end

function CGuideCoursePayTable:getAllID()
	return self.allID
end

function CGuideCoursePayTable:getSize()
	return self.memberCount
end

function CGuideCoursePayTable:LoadBeanFromBinFile(filename)
