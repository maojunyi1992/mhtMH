...
CJingyingConfigTable = {}
CJingyingConfigTable.__index = CJingyingConfigTable

function CJingyingConfigTable:new()
	local self = {}
	setmetatable(self, CJingyingConfigTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CJingyingConfigTable:getRecorder(id)
	return self.m_cache[id]
end

function CJingyingConfigTable:getAllID()
	return self.allID
end

function CJingyingConfigTable:getSize()
	return self.memberCount
end

function CJingyingConfigTable:LoadBeanFromBinFile(filename)
