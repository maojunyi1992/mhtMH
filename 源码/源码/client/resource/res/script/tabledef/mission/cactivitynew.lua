...
CActivityNewTable = {}
CActivityNewTable.__index = CActivityNewTable

function CActivityNewTable:new()
	local self = {}
	setmetatable(self, CActivityNewTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CActivityNewTable:getRecorder(id)
	return self.m_cache[id]
end

function CActivityNewTable:getAllID()
	return self.allID
end

function CActivityNewTable:getSize()
	return self.memberCount
end

function CActivityNewTable:LoadBeanFromBinFile(filename)
