...
CWeeklyrewardscwTable = {}
CWeeklyrewardscwTable.__index = CWeeklyrewardscwTable

function CWeeklyrewardscwTable:new()
	local self = {}
	setmetatable(self, CWeeklyrewardscwTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CWeeklyrewardscwTable:getRecorder(id)
	return self.m_cache[id]
end

function CWeeklyrewardscwTable:getAllID()
	return self.allID
end

function CWeeklyrewardscwTable:getSize()
	return self.memberCount
end

function CWeeklyrewardscwTable:LoadBeanFromBinFile(filename)
