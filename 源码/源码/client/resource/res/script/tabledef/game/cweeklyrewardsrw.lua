...
CWeeklyrewardsrwTable = {}
CWeeklyrewardsrwTable.__index = CWeeklyrewardsrwTable

function CWeeklyrewardsrwTable:new()
	local self = {}
	setmetatable(self, CWeeklyrewardsrwTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CWeeklyrewardsrwTable:getRecorder(id)
	return self.m_cache[id]
end

function CWeeklyrewardsrwTable:getAllID()
	return self.allID
end

function CWeeklyrewardsrwTable:getSize()
	return self.memberCount
end

function CWeeklyrewardsrwTable:LoadBeanFromBinFile(filename)
