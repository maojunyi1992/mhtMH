...
CrankawardcwTable = {}
CrankawardcwTable.__index = CrankawardcwTable

function CrankawardcwTable:new()
	local self = {}
	setmetatable(self, CrankawardcwTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CrankawardcwTable:getRecorder(id)
	return self.m_cache[id]
end

function CrankawardcwTable:getAllID()
	return self.allID
end

function CrankawardcwTable:getSize()
	return self.memberCount
end

function CrankawardcwTable:LoadBeanFromBinFile(filename)
