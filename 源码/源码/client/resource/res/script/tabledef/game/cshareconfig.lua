...
CShareConfigTable = {}
CShareConfigTable.__index = CShareConfigTable

function CShareConfigTable:new()
	local self = {}
	setmetatable(self, CShareConfigTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CShareConfigTable:getRecorder(id)
	return self.m_cache[id]
end

function CShareConfigTable:getAllID()
	return self.allID
end

function CShareConfigTable:getSize()
	return self.memberCount
end

function CShareConfigTable:LoadBeanFromBinFile(filename)
