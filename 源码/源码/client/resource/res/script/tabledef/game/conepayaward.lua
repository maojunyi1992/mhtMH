...
COnePayAwardTable = {}
COnePayAwardTable.__index = COnePayAwardTable

function COnePayAwardTable:new()
	local self = {}
	setmetatable(self, COnePayAwardTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function COnePayAwardTable:getRecorder(id)
	return self.m_cache[id]
end

function COnePayAwardTable:getAllID()
	return self.allID
end

function COnePayAwardTable:getSize()
	return self.memberCount
end

function COnePayAwardTable:LoadBeanFromBinFile(filename)
