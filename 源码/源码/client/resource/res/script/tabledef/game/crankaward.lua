...
CrankawardTable = {}
CrankawardTable.__index = CrankawardTable

function CrankawardTable:new()
	local self = {}
	setmetatable(self, CrankawardTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CrankawardTable:getRecorder(id)
	return self.m_cache[id]
end

function CrankawardTable:getAllID()
	return self.allID
end

function CrankawardTable:getSize()
	return self.memberCount
end

function CrankawardTable:LoadBeanFromBinFile(filename)
