...
CPresentConfigTable = {}
CPresentConfigTable.__index = CPresentConfigTable

function CPresentConfigTable:new()
	local self = {}
	setmetatable(self, CPresentConfigTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CPresentConfigTable:getRecorder(id)
	return self.m_cache[id]
end

function CPresentConfigTable:getAllID()
	return self.allID
end

function CPresentConfigTable:getSize()
	return self.memberCount
end

function CPresentConfigTable:LoadBeanFromBinFile(filename)
