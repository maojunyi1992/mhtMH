...
CTaskRelativeTable = {}
CTaskRelativeTable.__index = CTaskRelativeTable

function CTaskRelativeTable:new()
	local self = {}
	setmetatable(self, CTaskRelativeTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CTaskRelativeTable:getRecorder(id)
	return self.m_cache[id]
end

function CTaskRelativeTable:getAllID()
	return self.allID
end

function CTaskRelativeTable:getSize()
	return self.memberCount
end

function CTaskRelativeTable:LoadBeanFromBinFile(filename)
