...
DCEquipCombinTable = {}
DCEquipCombinTable.__index = DCEquipCombinTable

function DCEquipCombinTable:new()
	local self = {}
	setmetatable(self, DCEquipCombinTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function DCEquipCombinTable:getRecorder(id)
	return self.m_cache[id]
end

function DCEquipCombinTable:getAllID()
	return self.allID
end

function DCEquipCombinTable:getSize()
	return self.memberCount
end

function DCEquipCombinTable:LoadBeanFromBinFile(filename)
