...
CItemAttr_PointCardTable = {}
CItemAttr_PointCardTable.__index = CItemAttr_PointCardTable

function CItemAttr_PointCardTable:new()
	local self = {}
	setmetatable(self, CItemAttr_PointCardTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CItemAttr_PointCardTable:getRecorder(id)
	return self.m_cache[id]
end

function CItemAttr_PointCardTable:getAllID()
	return self.allID
end

function CItemAttr_PointCardTable:getSize()
	return self.memberCount
end

function CItemAttr_PointCardTable:LoadBeanFromBinFile(filename)
...
return CItemAttr_PointCardTable
