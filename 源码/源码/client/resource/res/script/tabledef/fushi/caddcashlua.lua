...
CAddCashluaTable = {}
CAddCashluaTable.__index = CAddCashluaTable

function CAddCashluaTable:new()
	local self = {}
	setmetatable(self, CAddCashluaTable)
	self.m_cache = {}
	self.allID = {}
	return self
...
function CAddCashluaTable:getRecorder(id)
	return self.m_cache[id]
end

function CAddCashluaTable:getAllID()
	return self.allID
end

function CAddCashluaTable:getSize()
	return self.memberCount
end

function CAddCashluaTable:LoadBeanFromBinFile(filename)
