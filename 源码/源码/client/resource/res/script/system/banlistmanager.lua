...
function BanListManager:AddRole(roleid)
	...
	--the role is in friend list
	if gGetFriendsManager():isMyFriend(roleid) then
		GetCTipsManager():AddMessageTipById(141405)
		return
	end
	...
	require "protodef.fire.pb.pingbi.caddblackrole"
...
function BanListManager:RemoveRole(roleid)
	...
	--require add the role in ban list
	require "protodef.fire.pb.pingbi.cremoveblackrole"
