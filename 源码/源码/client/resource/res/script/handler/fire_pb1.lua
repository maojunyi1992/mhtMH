...
function screaterole:process(args)
	...
	local nProtocolId = Spaceprotocol.eProId.setrole
	...
	gGetSpaceManager():SendRequest(strProtocolParam,GameTable.common.GetCCommonTableInstance():getRecorder(487).value.."?account="..account.."&serverid="..serverid.."&roleid="..self.newinfo.roleid.."&action=index",nHttpType,nTimeout)
end
...
function enterword:process()
    ...
    print(">>>>>>>>>>>>׼����ͼ��������!")
    --��ͼ��������
    gGetScene():AddMainCharacter(self.mydata.roleid, GetRoleSex(self.mydata.shape % 100), self.mydata.shape % 100, 0)
