...
setmetatable(RecruitCell1Dg, Dialog)
RecruitCell1Dg.__index = RecruitCell1Dg

function RecruitCell1Dg.CreateNewDlg(parent)
	local newDlg = RecruitCell1Dg:new()
	newDlg:OnCreate(parent)
	return newDlg
end

function RecruitCell1Dg.GetLayoutFileName()
	return "recruitcell1dlg.layout"
end

function RecruitCell1Dg:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, RecruitCell1Dg)
	return self
end

function RecruitCell1Dg:OnCreate(parent)
	Dialog.OnCreate(self, parent)
	local winMgr = CEGUI.WindowManager:getSingleton()
    self.m_roleidText = winMgr:getWindow("recruitcell1dlg/wendizi2/")
    self.m_richNomalText = winMgr:getWindow("recruitcell1dlg/richedit/text11")
    self.m_richText = CEGUI.toRichEditbox(winMgr:getWindow("recruitcell1dlg/richedit1"))
    self.m_richText:subscribeEvent("CaratMoved", RecruitCell1Dg.HandleTextChange, self)
    ...
    self.m_tipBtn = CEGUI.toPushButton(winMgr:getWindow("recruitcell1dlg/"))
    self.m_tipBtn:subscribeEvent("MouseClick", RecruitCell1Dg.HandleTipClick, self)
    self.m_shareBtn = CEGUI.toPushButton(winMgr:getWindow("recruitcell1dlg/share"))
    self.m_shareBtn:subscribeEvent("MouseClick", RecruitCell1Dg.HandleShareClick, self)
    -- windows 版本屏蔽分享
...
function RecruitCell1Dg:HandleShareClick()
...
function RecruitCell1Dg:setRoleId()
...
function RecruitCell1Dg:HandleTipClick(e)
...
function RecruitCell1Dg:HandleTextChange(e)
...
function RecruitCell1Dg:HandleKeyboardTargetWndChanged(args)
...
function RecruitCell1Dg:Update()
...
function RecruitCell1Dg.ShiedText(inText)
