...
function Equiptipmaker.makeBasePropertyzq(richBox,nItemId,pEquipData,nItemIdInBody,pObjInBody)----坐骑属性显示
    ...
    local itemtypeid = itemAttrCfg.itemtypeid
    ---排除除坐骑以外的属性显示
    if itemtypeid ~= 40 and itemtypeid ~= 72 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 376  and itemtypeid ~= 712 and itemtypeid ~= 728 and itemtypeid ~= 744 and itemtypeid ~= 392 and itemtypeid ~= 616 and itemtypeid ~= 632 and itemtypeid ~= 648 and itemtypeid ~= 664 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
...
function Equiptipmaker.makeBaseProperty1(richBox,nItemId,pEquipData,nItemIdInBody,pObjInBody)----法宝属性显示
    ...
    local itemtypeid = itemAttrCfg.itemtypeid
    ---主装备类限制属性显示
    if itemtypeid ~= 376 and itemtypeid ~= 40 and itemtypeid ~= 72 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 680 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
...
function Equiptipmaker.makeAddPropertycc(richBox,nItemId,pEquipData)----星印附加属性
	...
	local itemAttrCfg = BeanConfigManager.getInstance():GetTableByName("item.citemattr"):getRecorder(nItemId)
    local itemtypeid = itemAttrCfg.itemtypeid
	if itemtypeid ~= 40 and itemtypeid ~= 72 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
...
function Equiptipmaker.makeSkill1(richBox,nItemId,pEquipData)---法宝特效特技显示
    ...
    local itemtypeid = itemAttrCfg.itemtypeid
	------排除主装备
    if itemtypeid ~= 376 and itemtypeid ~= 680 and itemtypeid ~= 40 and itemtypeid ~= 72 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then	
   local texiaoTable = BeanConfigManager.getInstance():GetTableByName("skill.cequipskillinfo"):getRecorder(nTexiaoId)
    if texiaoTable and texiaoTable.id ~= -1 then
        local strTeXiaozi = require "utils.mhsdutils".get_resstring(11813)
		richBox:AppendImage(CEGUI.String("ccui1"),CEGUI.String("zuo1"))
...
function Equiptipmaker.makeSkill111cc(richBox,nItemId,pEquipData)---师门法宝特效显示
    ...
    if itemtypeid ~= 40 and itemtypeid ~= 72  and itemtypeid ~= 712 and itemtypeid ~= 728 and itemtypeid ~= 744 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 376 and itemtypeid ~= 680 and itemtypeid ~= 616 and itemtypeid ~= 632 and itemtypeid ~= 648 and itemtypeid ~= 664 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
    ...
    if itemtypeid ~= 40 and itemtypeid ~= 72  and itemtypeid ~= 712 and itemtypeid ~= 728 and itemtypeid ~= 744 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 376 and itemtypeid ~= 392 and itemtypeid ~= 616 and itemtypeid ~= 632 and itemtypeid ~= 648 and itemtypeid ~= 664 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
    local tejiTable = BeanConfigManager.getInstance():GetTableByName("skill.cequipskillinfo"):getRecorder(nTejiId)
    if tejiTable and tejiTable.id ~= -1 then
         local strTejizi = require "utils.mhsdutils".get_resstring(11812)
         strTejizi = "  "..strTejizi.." "..tejiTable.name
...
function Equiptipmaker.makeSkill11(richBox,nItemId,pEquipData)---坐骑特效特技显示
    ...
    if itemtypeid ~= 40 and itemtypeid ~= 72 and itemtypeid ~= 88 and itemtypeid ~= 312 and itemtypeid ~= 568 and itemtypeid ~= 1288 and itemtypeid ~= 1384 and itemtypeid ~= 1640 and itemtypeid ~= 1800 and itemtypeid ~= 2824 and itemtypeid ~= 3080 and itemtypeid ~= 4104 and itemtypeid ~= 4360 and itemtypeid ~= 376 and itemtypeid ~= 392 and itemtypeid ~= 616 and itemtypeid ~= 632 and itemtypeid ~= 648  and itemtypeid ~= 712 and itemtypeid ~= 728 and itemtypeid ~= 744 and itemtypeid ~= 664 and itemtypeid ~= 168 and itemtypeid ~= 184 and itemtypeid ~= 696 and itemtypeid ~= 296 and itemtypeid ~= 408 and itemtypeid ~= 328 and itemtypeid ~= 760 then
    local tejiTable = BeanConfigManager.getInstance():GetTableByName("skill.cequipskillinfo"):getRecorder(nTejiId)
    if tejiTable and tejiTable.id ~= -1 then
         local strTejizi = require "utils.mhsdutils".get_resstring(11812)
         strTejizi = "  "..strTejizi.." "..tejiTable.name
