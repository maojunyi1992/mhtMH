...
function ZuoqipinzhiDlg:InitUI()
	...
	self.LabTargetName1 = winMgr:getWindow("zhuangbeichongzhu/rightc/partc2/namecc") 
	...
	self.zuoqishengji = CEGUI.toPushButton(winMgr:getWindow("zhuangbeichongzhu/ccshengji"))       --打开坐骑升级
	self.zuoqishengji:subscribeEvent("Clicked", ZuoqipinzhiDlg.zuoqishengjic, self)
	
	self.zuoqixilian = CEGUI.toPushButton(winMgr:getWindow("zhuangbeichongzhu/ccpinzhi"))       --打开坐骑洗炼
...
-- function ZuoqipinzhiDlg:RefreshTwoBtnSel()
