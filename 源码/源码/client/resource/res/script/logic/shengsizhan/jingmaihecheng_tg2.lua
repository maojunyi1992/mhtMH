...
jingmaihecheng_tg2 = {}
setmetatable(jingmaihecheng_tg2, Dialog)
jingmaihecheng_tg2.__index = jingmaihecheng_tg2

local _instance
function jingmaihecheng_tg2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_tg2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_tg2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_tg2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_tg2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_tg2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_tg2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_tg2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_tg2.GetLayoutFileName()
	return "jingmaihecheng_tg.layout"
end

function jingmaihecheng_tg2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_tg2)
	return self
end

function jingmaihecheng_tg2:OnCreate()
...
function jingmaihecheng_tg2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1tg1:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg1, self)
	self.m_hc1tg2:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg2, self)
	self.m_hc1tg3:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg3, self)
	self.m_hc1tg4:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg4, self)
	self.m_hc1tg5:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg5, self)
	self.m_hc1tg6:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg6, self)
	self.m_hc1tg7:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg7, self)
	self.m_hc1tg8:subscribeEvent("Clicked", jingmaihecheng_tg2.hc1tg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_tg2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1tg1 = 8020021
TaskHelper.m_hc1tg2 = 8020022
TaskHelper.m_hc1tg3 = 8020023
TaskHelper.m_hc1tg4 = 8020024
TaskHelper.m_hc1tg5 = 8020025
TaskHelper.m_hc1tg6 = 8020026
TaskHelper.m_hc1tg7 = 8020027
TaskHelper.m_hc1tg8 = 8020028

-- function jingmaihecheng_tg2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_tg2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_tg2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_tg2:jingmaibeibao(args)
