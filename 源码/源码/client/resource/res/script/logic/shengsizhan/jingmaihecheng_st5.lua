...
jingmaihecheng_st5 = {}
setmetatable(jingmaihecheng_st5, Dialog)
jingmaihecheng_st5.__index = jingmaihecheng_st5

local _instance
function jingmaihecheng_st5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_st5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_st5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_st5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_st5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_st5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_st5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st5.GetLayoutFileName()
	return "jingmaihecheng_st.layout"
end

function jingmaihecheng_st5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_st5)
	return self
end

function jingmaihecheng_st5:OnCreate()
...
function jingmaihecheng_st5:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1st1:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st1, self)
	self.m_hc1st2:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st2, self)
	self.m_hc1st3:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st3, self)
	self.m_hc1st4:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st4, self)
	self.m_hc1st5:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st5, self)
	self.m_hc1st6:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st6, self)
	self.m_hc1st7:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st7, self)
	self.m_hc1st8:subscribeEvent("Clicked", jingmaihecheng_st5.hc1st8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_st5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1st1 = 8013051
TaskHelper.m_hc1st2 = 8013052
TaskHelper.m_hc1st3 = 8013053
TaskHelper.m_hc1st4 = 8013054
TaskHelper.m_hc1st5 = 8013055
TaskHelper.m_hc1st6 = 8013056
TaskHelper.m_hc1st7 = 8013057
TaskHelper.m_hc1st8 = 8013058

-- function jingmaihecheng_st5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_st5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_st5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_st5:jingmaibeibao(args)
