...
jingmaihecheng_lg2 = {}
setmetatable(jingmaihecheng_lg2, Dialog)
jingmaihecheng_lg2.__index = jingmaihecheng_lg2

local _instance
function jingmaihecheng_lg2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_lg2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_lg2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_lg2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_lg2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_lg2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_lg2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg2.GetLayoutFileName()
	return "jingmaihecheng_lg.layout"
end

function jingmaihecheng_lg2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_lg2)
	return self
end

function jingmaihecheng_lg2:OnCreate()
...
function jingmaihecheng_lg2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1lg1:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg1, self)
	self.m_hc1lg2:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg2, self)
	self.m_hc1lg3:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg3, self)
	self.m_hc1lg4:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg4, self)
	self.m_hc1lg5:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg5, self)
	self.m_hc1lg6:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg6, self)
	self.m_hc1lg7:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg7, self)
	self.m_hc1lg8:subscribeEvent("Clicked", jingmaihecheng_lg2.hc1lg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_lg2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1lg1 = 8015021
TaskHelper.m_hc1lg2 = 8015022
TaskHelper.m_hc1lg3 = 8015023
TaskHelper.m_hc1lg4 = 8015024
TaskHelper.m_hc1lg5 = 8015025
TaskHelper.m_hc1lg6 = 8015026
TaskHelper.m_hc1lg7 = 8015027
TaskHelper.m_hc1lg8 = 8015028

-- function jingmaihecheng_lg2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_lg2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_lg2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_lg2:jingmaibeibao(args)
