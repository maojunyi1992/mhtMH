...
jingmaihecheng_st2 = {}
setmetatable(jingmaihecheng_st2, Dialog)
jingmaihecheng_st2.__index = jingmaihecheng_st2

local _instance
function jingmaihecheng_st2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_st2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_st2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_st2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_st2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_st2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_st2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st2.GetLayoutFileName()
	return "jingmaihecheng_st.layout"
end

function jingmaihecheng_st2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_st2)
	return self
end

function jingmaihecheng_st2:OnCreate()
...
function jingmaihecheng_st2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1st1:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st1, self)
	self.m_hc1st2:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st2, self)
	self.m_hc1st3:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st3, self)
	self.m_hc1st4:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st4, self)
	self.m_hc1st5:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st5, self)
	self.m_hc1st6:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st6, self)
	self.m_hc1st7:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st7, self)
	self.m_hc1st8:subscribeEvent("Clicked", jingmaihecheng_st2.hc1st8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_st2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1st1 = 8013021
TaskHelper.m_hc1st2 = 8013022
TaskHelper.m_hc1st3 = 8013023
TaskHelper.m_hc1st4 = 8013024
TaskHelper.m_hc1st5 = 8013025
TaskHelper.m_hc1st6 = 8013026
TaskHelper.m_hc1st7 = 8013027
TaskHelper.m_hc1st8 = 8013028

-- function jingmaihecheng_st2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_st2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_st2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_st2:jingmaibeibao(args)
