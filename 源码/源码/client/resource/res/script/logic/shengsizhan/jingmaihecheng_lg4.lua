...
jingmaihecheng_lg4 = {}
setmetatable(jingmaihecheng_lg4, Dialog)
jingmaihecheng_lg4.__index = jingmaihecheng_lg4

local _instance
function jingmaihecheng_lg4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_lg4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_lg4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_lg4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_lg4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_lg4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_lg4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg4.GetLayoutFileName()
	return "jingmaihecheng_lg.layout"
end

function jingmaihecheng_lg4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_lg4)
	return self
end

function jingmaihecheng_lg4:OnCreate()
...
function jingmaihecheng_lg4:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1lg1:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg1, self)
	self.m_hc1lg2:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg2, self)
	self.m_hc1lg3:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg3, self)
	self.m_hc1lg4:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg4, self)
	self.m_hc1lg5:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg5, self)
	self.m_hc1lg6:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg6, self)
	self.m_hc1lg7:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg7, self)
	self.m_hc1lg8:subscribeEvent("Clicked", jingmaihecheng_lg4.hc1lg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_lg4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1lg1 = 8015041
TaskHelper.m_hc1lg2 = 8015042
TaskHelper.m_hc1lg3 = 8015043
TaskHelper.m_hc1lg4 = 8015044
TaskHelper.m_hc1lg5 = 8015045
TaskHelper.m_hc1lg6 = 8015046
TaskHelper.m_hc1lg7 = 8015047
TaskHelper.m_hc1lg8 = 8015048

-- function jingmaihecheng_lg4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_lg4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_lg4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_lg4:jingmaibeibao(args)
