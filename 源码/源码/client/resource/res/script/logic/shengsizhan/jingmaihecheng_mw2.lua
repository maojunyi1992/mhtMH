...
jingmaihecheng_mw2 = {}
setmetatable(jingmaihecheng_mw2, Dialog)
jingmaihecheng_mw2.__index = jingmaihecheng_mw2

local _instance
function jingmaihecheng_mw2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_mw2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_mw2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_mw2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_mw2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_mw2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_mw2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw2.GetLayoutFileName()
	return "jingmaihecheng_mw.layout"
end

function jingmaihecheng_mw2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_mw2)
	return self
end

function jingmaihecheng_mw2:OnCreate()
...
function jingmaihecheng_mw2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1mw1:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw1, self)
	self.m_hc1mw2:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw2, self)
	self.m_hc1mw3:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw3, self)
	self.m_hc1mw4:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw4, self)
	self.m_hc1mw5:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw5, self)
	self.m_hc1mw6:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw6, self)
	self.m_hc1mw7:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw7, self)
	self.m_hc1mw8:subscribeEvent("Clicked", jingmaihecheng_mw2.hc1mw8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_mw2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1mw1 = 8017021
TaskHelper.m_hc1mw2 = 8017022
TaskHelper.m_hc1mw3 = 8017023
TaskHelper.m_hc1mw4 = 8017024
TaskHelper.m_hc1mw5 = 8017025
TaskHelper.m_hc1mw6 = 8017026
TaskHelper.m_hc1mw7 = 8017027
TaskHelper.m_hc1mw8 = 8017028

-- function jingmaihecheng_mw2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_mw2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_mw2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_mw2:jingmaibeibao(args)
