...
jingmaihecheng_ne5 = {}
setmetatable(jingmaihecheng_ne5, Dialog)
jingmaihecheng_ne5.__index = jingmaihecheng_ne5

local _instance
function jingmaihecheng_ne5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_ne5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_ne5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_ne5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_ne5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_ne5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_ne5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne5.GetLayoutFileName()
	return "jingmaihecheng_ne.layout"
end

function jingmaihecheng_ne5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_ne5)
	return self
end

function jingmaihecheng_ne5:OnCreate()
...
function jingmaihecheng_ne5:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1ne1:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne1, self)
	self.m_hc1ne2:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne2, self)
	self.m_hc1ne3:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne3, self)
	self.m_hc1ne4:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne4, self)
	self.m_hc1ne5:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne5, self)
	self.m_hc1ne6:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne6, self)
	self.m_hc1ne7:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne7, self)
	self.m_hc1ne8:subscribeEvent("Clicked", jingmaihecheng_ne5.hc1ne8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_ne5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1ne1 = 8022051
TaskHelper.m_hc1ne2 = 8022052
TaskHelper.m_hc1ne3 = 8022053
TaskHelper.m_hc1ne4 = 8022054
TaskHelper.m_hc1ne5 = 8022055
TaskHelper.m_hc1ne6 = 8022056
TaskHelper.m_hc1ne7 = 8022057
TaskHelper.m_hc1ne8 = 8022058

-- function jingmaihecheng_ne5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_ne5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_ne5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_ne5:jingmaibeibao(args)
