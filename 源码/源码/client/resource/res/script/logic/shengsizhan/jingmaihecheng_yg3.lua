...
jingmaihecheng_yg3 = {}
setmetatable(jingmaihecheng_yg3, Dialog)
jingmaihecheng_yg3.__index = jingmaihecheng_yg3

local _instance
function jingmaihecheng_yg3.getInstance()
	if not _instance then
		_instance = jingmaihecheng_yg3:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_yg3.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_yg3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_yg3.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_yg3.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_yg3.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_yg3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_yg3.GetLayoutFileName()
	return "jingmaihecheng_yg.layout"
end

function jingmaihecheng_yg3:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_yg3)
	return self
end

function jingmaihecheng_yg3:OnCreate()
...
function jingmaihecheng_yg3:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1yg1:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg1, self)
	self.m_hc1yg2:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg2, self)
	self.m_hc1yg3:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg3, self)
	self.m_hc1yg4:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg4, self)
	self.m_hc1yg5:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg5, self)
	self.m_hc1yg6:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg6, self)
	self.m_hc1yg7:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg7, self)
	self.m_hc1yg8:subscribeEvent("Clicked", jingmaihecheng_yg3.hc1yg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_yg3.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1yg1 = 8018031
TaskHelper.m_hc1yg2 = 8018032
TaskHelper.m_hc1yg3 = 8018033
TaskHelper.m_hc1yg4 = 8018034
TaskHelper.m_hc1yg5 = 8018035
TaskHelper.m_hc1yg6 = 8018036
TaskHelper.m_hc1yg7 = 8018037
TaskHelper.m_hc1yg8 = 8018038

-- function jingmaihecheng_yg3:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_yg3:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_yg3:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_yg3:jingmaibeibao(args)
