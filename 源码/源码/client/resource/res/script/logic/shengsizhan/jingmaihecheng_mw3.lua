...
jingmaihecheng_mw3 = {}
setmetatable(jingmaihecheng_mw3, Dialog)
jingmaihecheng_mw3.__index = jingmaihecheng_mw3

local _instance
function jingmaihecheng_mw3.getInstance()
	if not _instance then
		_instance = jingmaihecheng_mw3:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_mw3.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_mw3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw3.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_mw3.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_mw3.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_mw3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw3.GetLayoutFileName()
	return "jingmaihecheng_mw.layout"
end

function jingmaihecheng_mw3:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_mw3)
	return self
end

function jingmaihecheng_mw3:OnCreate()
...
function jingmaihecheng_mw3:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1mw1:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw1, self)
	self.m_hc1mw2:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw2, self)
	self.m_hc1mw3:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw3, self)
	self.m_hc1mw4:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw4, self)
	self.m_hc1mw5:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw5, self)
	self.m_hc1mw6:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw6, self)
	self.m_hc1mw7:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw7, self)
	self.m_hc1mw8:subscribeEvent("Clicked", jingmaihecheng_mw3.hc1mw8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_mw3.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1mw1 = 8017031
TaskHelper.m_hc1mw2 = 8017032
TaskHelper.m_hc1mw3 = 8017033
TaskHelper.m_hc1mw4 = 8017034
TaskHelper.m_hc1mw5 = 8017035
TaskHelper.m_hc1mw6 = 8017036
TaskHelper.m_hc1mw7 = 8017037
TaskHelper.m_hc1mw8 = 8017038

-- function jingmaihecheng_mw3:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_mw3:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_mw3:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_mw3:jingmaibeibao(args)
