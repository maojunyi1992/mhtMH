...
jingmaihecheng_wz2 = {}
setmetatable(jingmaihecheng_wz2, Dialog)
jingmaihecheng_wz2.__index = jingmaihecheng_wz2

local _instance
function jingmaihecheng_wz2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_wz2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_wz2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_wz2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_wz2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_wz2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_wz2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_wz2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_wz2.GetLayoutFileName()
	return "jingmaihecheng_wz.layout"
end

function jingmaihecheng_wz2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_wz2)
	return self
end

function jingmaihecheng_wz2:OnCreate()
...
function jingmaihecheng_wz2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1wz1:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz1, self)
	self.m_hc1wz2:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz2, self)
	self.m_hc1wz3:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz3, self)
	self.m_hc1wz4:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz4, self)
	self.m_hc1wz5:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz5, self)
	self.m_hc1wz6:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz6, self)
	self.m_hc1wz7:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz7, self)
	self.m_hc1wz8:subscribeEvent("Clicked", jingmaihecheng_wz2.hc1wz8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_wz2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1wz1 = 8021021
TaskHelper.m_hc1wz2 = 8021022
TaskHelper.m_hc1wz3 = 8021023
TaskHelper.m_hc1wz4 = 8021024
TaskHelper.m_hc1wz5 = 8021025
TaskHelper.m_hc1wz6 = 8021026
TaskHelper.m_hc1wz7 = 8021027
TaskHelper.m_hc1wz8 = 8021028

-- function jingmaihecheng_wz2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_wz2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_wz2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_wz2:jingmaibeibao(args)
