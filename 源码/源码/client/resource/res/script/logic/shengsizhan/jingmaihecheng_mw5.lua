...
jingmaihecheng_mw5 = {}
setmetatable(jingmaihecheng_mw5, Dialog)
jingmaihecheng_mw5.__index = jingmaihecheng_mw5

local _instance
function jingmaihecheng_mw5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_mw5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_mw5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_mw5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_mw5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_mw5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_mw5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_mw5.GetLayoutFileName()
	return "jingmaihecheng_mw.layout"
end

function jingmaihecheng_mw5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_mw5)
	return self
end

function jingmaihecheng_mw5:OnCreate()
...
function jingmaihecheng_mw5:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1mw1:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw1, self)
	self.m_hc1mw2:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw2, self)
	self.m_hc1mw3:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw3, self)
	self.m_hc1mw4:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw4, self)
	self.m_hc1mw5:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw5, self)
	self.m_hc1mw6:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw6, self)
	self.m_hc1mw7:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw7, self)
	self.m_hc1mw8:subscribeEvent("Clicked", jingmaihecheng_mw5.hc1mw8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_mw5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1mw1 = 8017051
TaskHelper.m_hc1mw2 = 8017052
TaskHelper.m_hc1mw3 = 8017053
TaskHelper.m_hc1mw4 = 8017054
TaskHelper.m_hc1mw5 = 8017055
TaskHelper.m_hc1mw6 = 8017056
TaskHelper.m_hc1mw7 = 8017057
TaskHelper.m_hc1mw8 = 8017058

-- function jingmaihecheng_mw5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_mw5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_mw5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_mw5:jingmaibeibao(args)
