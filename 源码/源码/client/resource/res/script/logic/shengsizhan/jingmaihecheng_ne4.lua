...
jingmaihecheng_ne4 = {}
setmetatable(jingmaihecheng_ne4, Dialog)
jingmaihecheng_ne4.__index = jingmaihecheng_ne4

local _instance
function jingmaihecheng_ne4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_ne4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_ne4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_ne4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_ne4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_ne4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_ne4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne4.GetLayoutFileName()
	return "jingmaihecheng_ne.layout"
end

function jingmaihecheng_ne4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_ne4)
	return self
end

function jingmaihecheng_ne4:OnCreate()
...
function jingmaihecheng_ne4:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1ne1:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne1, self)
	self.m_hc1ne2:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne2, self)
	self.m_hc1ne3:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne3, self)
	self.m_hc1ne4:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne4, self)
	self.m_hc1ne5:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne5, self)
	self.m_hc1ne6:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne6, self)
	self.m_hc1ne7:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne7, self)
	self.m_hc1ne8:subscribeEvent("Clicked", jingmaihecheng_ne4.hc1ne8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_ne4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1ne1 = 8022041
TaskHelper.m_hc1ne2 = 8022042
TaskHelper.m_hc1ne3 = 8022043
TaskHelper.m_hc1ne4 = 8022044
TaskHelper.m_hc1ne5 = 8022045
TaskHelper.m_hc1ne6 = 8022046
TaskHelper.m_hc1ne7 = 8022047
TaskHelper.m_hc1ne8 = 8022048

-- function jingmaihecheng_ne4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_ne4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_ne4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_ne4:jingmaibeibao(args)
