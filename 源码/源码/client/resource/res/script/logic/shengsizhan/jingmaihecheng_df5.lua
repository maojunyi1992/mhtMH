...
jingmaihecheng_df5 = {}
setmetatable(jingmaihecheng_df5, Dialog)
jingmaihecheng_df5.__index = jingmaihecheng_df5

local _instance
function jingmaihecheng_df5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_df5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_df5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_df5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_df5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_df5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_df5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_df5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_df5.GetLayoutFileName()
	return "jingmaihecheng_df.layout"
end

function jingmaihecheng_df5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_df5)
	return self
end

function jingmaihecheng_df5:OnCreate()
...
function jingmaihecheng_df5:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1df1:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df1, self)
	self.m_hc1df2:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df2, self)
	self.m_hc1df3:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df3, self)
	self.m_hc1df4:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df4, self)
	self.m_hc1df5:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df5, self)
	self.m_hc1df6:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df6, self)
	self.m_hc1df7:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df7, self)
	self.m_hc1df8:subscribeEvent("Clicked", jingmaihecheng_df5.hc1df8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_df5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1df1 = 8014051
TaskHelper.m_hc1df2 = 8014052
TaskHelper.m_hc1df3 = 8014053
TaskHelper.m_hc1df4 = 8014054
TaskHelper.m_hc1df5 = 8014055
TaskHelper.m_hc1df6 = 8014056
TaskHelper.m_hc1df7 = 8014057
TaskHelper.m_hc1df8 = 8014058

-- function jingmaihecheng_df5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_df5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_df5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_df5:jingmaibeibao(args)
