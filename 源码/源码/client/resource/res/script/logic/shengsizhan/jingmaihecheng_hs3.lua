...
jingmaihecheng_hs3 = {}
setmetatable(jingmaihecheng_hs3, Dialog)
jingmaihecheng_hs3.__index = jingmaihecheng_hs3

local _instance
function jingmaihecheng_hs3.getInstance()
	if not _instance then
		_instance = jingmaihecheng_hs3:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_hs3.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_hs3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs3.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_hs3.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_hs3.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_hs3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs3.GetLayoutFileName()
	return "jingmaihecheng_hs.layout"
end

function jingmaihecheng_hs3:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_hs3)
	return self
end

function jingmaihecheng_hs3:OnCreate()
...
function jingmaihecheng_hs3:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1hs1:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs1, self)
	self.m_hc1hs2:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs2, self)
	self.m_hc1hs3:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs3, self)
	self.m_hc1hs4:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs4, self)
	self.m_hc1hs5:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs5, self)
	self.m_hc1hs6:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs6, self)
	self.m_hc1hs7:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs7, self)
	self.m_hc1hs8:subscribeEvent("Clicked", jingmaihecheng_hs3.hc1hs8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_hs3.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1hs1 = 8019031
TaskHelper.m_hc1hs2 = 8019032
TaskHelper.m_hc1hs3 = 8019033
TaskHelper.m_hc1hs4 = 8019034
TaskHelper.m_hc1hs5 = 8019035
TaskHelper.m_hc1hs6 = 8019036
TaskHelper.m_hc1hs7 = 8019037
TaskHelper.m_hc1hs8 = 8019038

-- function jingmaihecheng_hs3:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_hs3:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_hs3:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_hs3:jingmaibeibao(args)
