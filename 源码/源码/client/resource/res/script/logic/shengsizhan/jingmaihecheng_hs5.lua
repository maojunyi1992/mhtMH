...
jingmaihecheng_hs5 = {}
setmetatable(jingmaihecheng_hs5, Dialog)
jingmaihecheng_hs5.__index = jingmaihecheng_hs5

local _instance
function jingmaihecheng_hs5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_hs5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_hs5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_hs5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_hs5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_hs5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_hs5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs5.GetLayoutFileName()
	return "jingmaihecheng_hs.layout"
end

function jingmaihecheng_hs5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_hs5)
	return self
end

function jingmaihecheng_hs5:OnCreate()
...
function jingmaihecheng_hs5:OnCreate()
	...
	self.m_hsbiaoti2:setVisible(false)
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1hs1:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs1, self)
	self.m_hc1hs2:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs2, self)
	self.m_hc1hs3:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs3, self)
	self.m_hc1hs4:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs4, self)
	self.m_hc1hs5:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs5, self)
	self.m_hc1hs6:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs6, self)
	self.m_hc1hs7:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs7, self)
	self.m_hc1hs8:subscribeEvent("Clicked", jingmaihecheng_hs5.hc1hs8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_hs5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1hs1 = 8019051
TaskHelper.m_hc1hs2 = 8019052
TaskHelper.m_hc1hs3 = 8019053
TaskHelper.m_hc1hs4 = 8019054
TaskHelper.m_hc1hs5 = 8019055
TaskHelper.m_hc1hs6 = 8019056
TaskHelper.m_hc1hs7 = 8019057
TaskHelper.m_hc1hs8 = 8019058

-- function jingmaihecheng_hs5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_hs5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_hs5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_hs5:jingmaibeibao(args)
