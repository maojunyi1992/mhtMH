...
jingmaihecheng_hs4 = {}
setmetatable(jingmaihecheng_hs4, Dialog)
jingmaihecheng_hs4.__index = jingmaihecheng_hs4

local _instance
function jingmaihecheng_hs4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_hs4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_hs4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_hs4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_hs4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_hs4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_hs4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_hs4.GetLayoutFileName()
	return "jingmaihecheng_hs.layout"
end

function jingmaihecheng_hs4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_hs4)
	return self
end

function jingmaihecheng_hs4:OnCreate()
...
function jingmaihecheng_hs4:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1hs1:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs1, self)
	self.m_hc1hs2:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs2, self)
	self.m_hc1hs3:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs3, self)
	self.m_hc1hs4:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs4, self)
	self.m_hc1hs5:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs5, self)
	self.m_hc1hs6:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs6, self)
	self.m_hc1hs7:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs7, self)
	self.m_hc1hs8:subscribeEvent("Clicked", jingmaihecheng_hs4.hc1hs8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_hs4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1hs1 = 8019041
TaskHelper.m_hc1hs2 = 8019042
TaskHelper.m_hc1hs3 = 8019043
TaskHelper.m_hc1hs4 = 8019044
TaskHelper.m_hc1hs5 = 8019045
TaskHelper.m_hc1hs6 = 8019046
TaskHelper.m_hc1hs7 = 8019047
TaskHelper.m_hc1hs8 = 8019048

-- function jingmaihecheng_hs4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_hs4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_hs4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_hs4:jingmaibeibao(args)
