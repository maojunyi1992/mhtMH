...
function jingmaihecheng_dt1:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_dt1.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1dt1 = 930447
TaskHelper.m_hc1dt2 = 930448
TaskHelper.m_hc1dt3 = 930449
TaskHelper.m_hc1dt4 = 930450
TaskHelper.m_hc1dt5 = 930451
TaskHelper.m_hc1dt6 = 930452
TaskHelper.m_hc1dt7 = 930453
TaskHelper.m_hc1dt8 = 930454

-- function jingmaihecheng_dt1:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_dt1:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_dt1:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_dt1:jingmaibeibao(args)
