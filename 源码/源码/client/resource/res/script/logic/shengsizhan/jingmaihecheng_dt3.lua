...
jingmaihecheng_dt3 = {}
setmetatable(jingmaihecheng_dt3, Dialog)
jingmaihecheng_dt3.__index = jingmaihecheng_dt3

local _instance
function jingmaihecheng_dt3.getInstance()
	if not _instance then
		_instance = jingmaihecheng_dt3:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_dt3.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_dt3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt3.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_dt3.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_dt3.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_dt3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt3.GetLayoutFileName()
	return "jingmaihecheng_dt.layout"
end

function jingmaihecheng_dt3:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_dt3)
	return self
end

function jingmaihecheng_dt3:OnCreate()
...
function jingmaihecheng_dt3:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1dt1:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt1, self)
	self.m_hc1dt2:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt2, self)
	self.m_hc1dt3:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt3, self)
	self.m_hc1dt4:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt4, self)
	self.m_hc1dt5:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt5, self)
	self.m_hc1dt6:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt6, self)
	self.m_hc1dt7:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt7, self)
	self.m_hc1dt8:subscribeEvent("Clicked", jingmaihecheng_dt3.hc1dt8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_dt3.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1dt1 = 8011031
TaskHelper.m_hc1dt2 = 8011032
TaskHelper.m_hc1dt3 = 8011033
TaskHelper.m_hc1dt4 = 8011034
TaskHelper.m_hc1dt5 = 8011035
TaskHelper.m_hc1dt6 = 8011036
TaskHelper.m_hc1dt7 = 8011037
TaskHelper.m_hc1dt8 = 8011038

-- function jingmaihecheng_dt3:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_dt3:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_dt3:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_dt3:jingmaibeibao(args)
