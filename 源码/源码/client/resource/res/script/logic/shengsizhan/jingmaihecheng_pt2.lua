...
jingmaihecheng_pt2 = {}
setmetatable(jingmaihecheng_pt2, Dialog)
jingmaihecheng_pt2.__index = jingmaihecheng_pt2

local _instance
function jingmaihecheng_pt2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_pt2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_pt2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_pt2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_pt2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_pt2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_pt2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_pt2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_pt2.GetLayoutFileName()
	return "jingmaihecheng_pt.layout"
end

function jingmaihecheng_pt2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_pt2)
	return self
end

function jingmaihecheng_pt2:OnCreate()
...
function jingmaihecheng_pt2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1pt1:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt1, self)
	self.m_hc1pt2:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt2, self)
	self.m_hc1pt3:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt3, self)
	self.m_hc1pt4:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt4, self)
	self.m_hc1pt5:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt5, self)
	self.m_hc1pt6:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt6, self)
	self.m_hc1pt7:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt7, self)
	self.m_hc1pt8:subscribeEvent("Clicked", jingmaihecheng_pt2.hc1pt8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_pt2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1pt1 = 8016021
TaskHelper.m_hc1pt2 = 8016022
TaskHelper.m_hc1pt3 = 8016023
TaskHelper.m_hc1pt4 = 8016024
TaskHelper.m_hc1pt5 = 8016025
TaskHelper.m_hc1pt6 = 8016026
TaskHelper.m_hc1pt7 = 8016027
TaskHelper.m_hc1pt8 = 8016028

-- function jingmaihecheng_pt2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_pt2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_pt2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_pt2:jingmaibeibao(args)
