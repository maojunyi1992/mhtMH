...
jingmaihecheng_ne2 = {}
setmetatable(jingmaihecheng_ne2, Dialog)
jingmaihecheng_ne2.__index = jingmaihecheng_ne2

local _instance
function jingmaihecheng_ne2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_ne2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_ne2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_ne2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_ne2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_ne2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_ne2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne2.GetLayoutFileName()
	return "jingmaihecheng_ne.layout"
end

function jingmaihecheng_ne2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_ne2)
	return self
end

function jingmaihecheng_ne2:OnCreate()
...
function jingmaihecheng_ne2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1ne1:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne1, self)
	self.m_hc1ne2:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne2, self)
	self.m_hc1ne3:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne3, self)
	self.m_hc1ne4:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne4, self)
	self.m_hc1ne5:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne5, self)
	self.m_hc1ne6:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne6, self)
	self.m_hc1ne7:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne7, self)
	self.m_hc1ne8:subscribeEvent("Clicked", jingmaihecheng_ne2.hc1ne8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_ne2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1ne1 = 8022021
TaskHelper.m_hc1ne2 = 8022022
TaskHelper.m_hc1ne3 = 8022023
TaskHelper.m_hc1ne4 = 8022024
TaskHelper.m_hc1ne5 = 8022025
TaskHelper.m_hc1ne6 = 8022026
TaskHelper.m_hc1ne7 = 8022027
TaskHelper.m_hc1ne8 = 8022028

-- function jingmaihecheng_ne2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_ne2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_ne2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_ne2:jingmaibeibao(args)
