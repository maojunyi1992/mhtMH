...
jingmaihecheng_dt2 = {}
setmetatable(jingmaihecheng_dt2, Dialog)
jingmaihecheng_dt2.__index = jingmaihecheng_dt2

local _instance
function jingmaihecheng_dt2.getInstance()
	if not _instance then
		_instance = jingmaihecheng_dt2:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_dt2.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_dt2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt2.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_dt2.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_dt2.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_dt2:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt2.GetLayoutFileName()
	return "jingmaihecheng_dt.layout"
end

function jingmaihecheng_dt2:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_dt2)
	return self
end

function jingmaihecheng_dt2:OnCreate()
...
function jingmaihecheng_dt2:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1dt1:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt1, self)
	self.m_hc1dt2:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt2, self)
	self.m_hc1dt3:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt3, self)
	self.m_hc1dt4:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt4, self)
	self.m_hc1dt5:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt5, self)
	self.m_hc1dt6:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt6, self)
	self.m_hc1dt7:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt7, self)
	self.m_hc1dt8:subscribeEvent("Clicked", jingmaihecheng_dt2.hc1dt8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_dt2.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1dt1 = 8011021
TaskHelper.m_hc1dt2 = 8011022
TaskHelper.m_hc1dt3 = 8011023
TaskHelper.m_hc1dt4 = 8011024
TaskHelper.m_hc1dt5 = 8011025
TaskHelper.m_hc1dt6 = 8011026
TaskHelper.m_hc1dt7 = 8011027
TaskHelper.m_hc1dt8 = 8011028

-- function jingmaihecheng_dt2:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_dt2:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_dt2:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_dt2:jingmaibeibao(args)
