...
jingmaihecheng_fc5 = {}
setmetatable(jingmaihecheng_fc5, Dialog)
jingmaihecheng_fc5.__index = jingmaihecheng_fc5

local _instance
function jingmaihecheng_fc5.getInstance()
	if not _instance then
		_instance = jingmaihecheng_fc5:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_fc5.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_fc5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_fc5.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_fc5.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_fc5.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_fc5:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_fc5.GetLayoutFileName()
	return "jingmaihecheng_fc.layout"
end

function jingmaihecheng_fc5:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_fc5)
	return self
end

function jingmaihecheng_fc5:OnCreate()
...
function jingmaihecheng_fc5:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1fc1:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc1, self)
	self.m_hc1fc2:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc2, self)
	self.m_hc1fc3:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc3, self)
	self.m_hc1fc4:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc4, self)
	self.m_hc1fc5:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc5, self)
	self.m_hc1fc6:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc6, self)
	self.m_hc1fc7:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc7, self)
	self.m_hc1fc8:subscribeEvent("Clicked", jingmaihecheng_fc5.hc1fc8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_fc5.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1fc1 = 8012051
TaskHelper.m_hc1fc2 = 8012052
TaskHelper.m_hc1fc3 = 8012053
TaskHelper.m_hc1fc4 = 8012054
TaskHelper.m_hc1fc5 = 8012055
TaskHelper.m_hc1fc6 = 8012056
TaskHelper.m_hc1fc7 = 8012057
TaskHelper.m_hc1fc8 = 8012058

-- function jingmaihecheng_fc5:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_fc5:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_fc5:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_fc5:jingmaibeibao(args)
