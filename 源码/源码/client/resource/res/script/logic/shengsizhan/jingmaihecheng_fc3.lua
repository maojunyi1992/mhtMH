...
jingmaihecheng_fc3 = {}
setmetatable(jingmaihecheng_fc3, Dialog)
jingmaihecheng_fc3.__index = jingmaihecheng_fc3

local _instance
function jingmaihecheng_fc3.getInstance()
	if not _instance then
		_instance = jingmaihecheng_fc3:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_fc3.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_fc3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_fc3.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_fc3.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_fc3.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_fc3:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_fc3.GetLayoutFileName()
	return "jingmaihecheng_fc.layout"
end

function jingmaihecheng_fc3:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_fc3)
	return self
end

function jingmaihecheng_fc3:OnCreate()
...
function jingmaihecheng_fc3:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1fc1:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc1, self)
	self.m_hc1fc2:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc2, self)
	self.m_hc1fc3:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc3, self)
	self.m_hc1fc4:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc4, self)
	self.m_hc1fc5:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc5, self)
	self.m_hc1fc6:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc6, self)
	self.m_hc1fc7:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc7, self)
	self.m_hc1fc8:subscribeEvent("Clicked", jingmaihecheng_fc3.hc1fc8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_fc3.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1fc1 = 8012031
TaskHelper.m_hc1fc2 = 8012032
TaskHelper.m_hc1fc3 = 8012033
TaskHelper.m_hc1fc4 = 8012034
TaskHelper.m_hc1fc5 = 8012035
TaskHelper.m_hc1fc6 = 8012036
TaskHelper.m_hc1fc7 = 8012037
TaskHelper.m_hc1fc8 = 8012038

-- function jingmaihecheng_fc3:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_fc3:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_fc3:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_fc3:jingmaibeibao(args)
