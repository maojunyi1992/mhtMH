...
function jingmaihecheng_df1:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1df1:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df1, self)
	self.m_hc1df2:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df2, self)
	self.m_hc1df3:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df3, self)
	self.m_hc1df4:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df4, self)
	self.m_hc1df5:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df5, self)
	self.m_hc1df6:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df6, self)
	self.m_hc1df7:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df7, self)
	self.m_hc1df8:subscribeEvent("Clicked", jingmaihecheng_df1.hc1df8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_df1.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1df1 = 930471
TaskHelper.m_hc1df2 = 930472
TaskHelper.m_hc1df3 = 930473
TaskHelper.m_hc1df4 = 930474
TaskHelper.m_hc1df5 = 930475
TaskHelper.m_hc1df6 = 930476
TaskHelper.m_hc1df7 = 930477
TaskHelper.m_hc1df8 = 930478

-- function jingmaihecheng_df1:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_df1:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_df1:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_df1:jingmaibeibao(args)
