...
jingmaihecheng_dt4 = {}
setmetatable(jingmaihecheng_dt4, Dialog)
jingmaihecheng_dt4.__index = jingmaihecheng_dt4

local _instance
function jingmaihecheng_dt4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_dt4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_dt4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_dt4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_dt4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_dt4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_dt4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_dt4.GetLayoutFileName()
	return "jingmaihecheng_dt.layout"
end

function jingmaihecheng_dt4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_dt4)
	return self
end

function jingmaihecheng_dt4:OnCreate()
...
function jingmaihecheng_dt4:OnCreate()
	...
	self.m_dtbiaoti5:setVisible(false)
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1dt1:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt1, self)
	self.m_hc1dt2:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt2, self)
	self.m_hc1dt3:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt3, self)
	self.m_hc1dt4:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt4, self)
	self.m_hc1dt5:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt5, self)
	self.m_hc1dt6:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt6, self)
	self.m_hc1dt7:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt7, self)
	self.m_hc1dt8:subscribeEvent("Clicked", jingmaihecheng_dt4.hc1dt8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_dt4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1dt1 = 8011041
TaskHelper.m_hc1dt2 = 8011042
TaskHelper.m_hc1dt3 = 8011043
TaskHelper.m_hc1dt4 = 8011044
TaskHelper.m_hc1dt5 = 8011045
TaskHelper.m_hc1dt6 = 8011046
TaskHelper.m_hc1dt7 = 8011047
TaskHelper.m_hc1dt8 = 8011048

-- function jingmaihecheng_dt4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_dt4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_dt4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_dt4:jingmaibeibao(args)
