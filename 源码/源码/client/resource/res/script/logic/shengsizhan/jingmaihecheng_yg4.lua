...
jingmaihecheng_yg4 = {}
setmetatable(jingmaihecheng_yg4, Dialog)
jingmaihecheng_yg4.__index = jingmaihecheng_yg4

local _instance
function jingmaihecheng_yg4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_yg4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_yg4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_yg4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_yg4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_yg4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_yg4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_yg4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_yg4.GetLayoutFileName()
	return "jingmaihecheng_yg.layout"
end

function jingmaihecheng_yg4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_yg4)
	return self
end

function jingmaihecheng_yg4:OnCreate()
...
function jingmaihecheng_yg4:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1yg1:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg1, self)
	self.m_hc1yg2:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg2, self)
	self.m_hc1yg3:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg3, self)
	self.m_hc1yg4:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg4, self)
	self.m_hc1yg5:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg5, self)
	self.m_hc1yg6:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg6, self)
	self.m_hc1yg7:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg7, self)
	self.m_hc1yg8:subscribeEvent("Clicked", jingmaihecheng_yg4.hc1yg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_yg4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1yg1 = 8018041
TaskHelper.m_hc1yg2 = 8018042
TaskHelper.m_hc1yg3 = 8018043
TaskHelper.m_hc1yg4 = 8018044
TaskHelper.m_hc1yg5 = 8018045
TaskHelper.m_hc1yg6 = 8018046
TaskHelper.m_hc1yg7 = 8018047
TaskHelper.m_hc1yg8 = 8018048

-- function jingmaihecheng_yg4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_yg4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_yg4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_yg4:jingmaibeibao(args)
