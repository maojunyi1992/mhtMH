...
jingmaihecheng_df4 = {}
setmetatable(jingmaihecheng_df4, Dialog)
jingmaihecheng_df4.__index = jingmaihecheng_df4

local _instance
function jingmaihecheng_df4.getInstance()
	if not _instance then
		_instance = jingmaihecheng_df4:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_df4.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_df4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_df4.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_df4.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_df4.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_df4:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_df4.GetLayoutFileName()
	return "jingmaihecheng_df.layout"
end

function jingmaihecheng_df4:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_df4)
	return self
end

function jingmaihecheng_df4:OnCreate()
...
function jingmaihecheng_df4:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1df1:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df1, self)
	self.m_hc1df2:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df2, self)
	self.m_hc1df3:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df3, self)
	self.m_hc1df4:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df4, self)
	self.m_hc1df5:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df5, self)
	self.m_hc1df6:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df6, self)
	self.m_hc1df7:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df7, self)
	self.m_hc1df8:subscribeEvent("Clicked", jingmaihecheng_df4.hc1df8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_df4.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1df1 = 8014041
TaskHelper.m_hc1df2 = 8014042
TaskHelper.m_hc1df3 = 8014043
TaskHelper.m_hc1df4 = 8014044
TaskHelper.m_hc1df5 = 8014045
TaskHelper.m_hc1df6 = 8014046
TaskHelper.m_hc1df7 = 8014047
TaskHelper.m_hc1df8 = 8014048

-- function jingmaihecheng_df4:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_df4:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_df4:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_df4:jingmaibeibao(args)
