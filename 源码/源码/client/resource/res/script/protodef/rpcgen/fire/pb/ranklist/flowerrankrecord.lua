...
FlowerRankRecord = {}
FlowerRankRecord.__index = FlowerRankRecord


function FlowerRankRecord:new()
	local self = {}
	setmetatable(self, FlowerRankRecord)
	self.rank = 0
	self.roleid = 0
	self.rolename = "" 
	self.school = 0
...
function FlowerRankRecord:marshal(ostream)
...
function FlowerRankRecord:unmarshal(_os_)
