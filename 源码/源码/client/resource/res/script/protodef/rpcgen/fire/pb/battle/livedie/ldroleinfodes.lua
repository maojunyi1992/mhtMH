...
LDRoleInfoDes = {}
LDRoleInfoDes.__index = LDRoleInfoDes


function LDRoleInfoDes:new()
	local self = {}
	setmetatable(self, LDRoleInfoDes)
	self.roleid = 0
	self.rolename = "" 
	self.shape = 0
	self.level = 0
...
function LDRoleInfoDes:marshal(ostream)
...
function LDRoleInfoDes:unmarshal(_os_)
